...
public class MonsterCtrl : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision coll)
    {
        if (coll.gameObject.tag == "BULLET")
        {
            ...
            a_Curpos.y += 2.27f;
            GameMgr.Inst.W_SpawnDmgTxt(-(int)coll.gameObject.GetComponent<BulletCtrl>().damage, a_Curpos, Color.red);
            //혈흔 효과 함수 호출
    ...
    void MonsterDie()
    {
        ...
        Debug.Log("스코어 : " + GlobalValue.g_BestScore);
